 ...
 ***********************************************************************/
 // @TODO: set request. Action can be passed as FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersByNextTokenRequest
              ...
              $response = $service->listAllFulfillmentOrdersByNextToken($request);
                ...
                if ($response->isSetListAllFulfillmentOrdersByNextTokenResult()) { 
                    ...
                    if ($listAllFulfillmentOrdersByNextTokenResult->isSetFulfillmentOrders()) { 
                        ...
                        $fulfillmentOrders = $listAllFulfillmentOrdersByNextTokenResult->getFulfillmentOrders();
